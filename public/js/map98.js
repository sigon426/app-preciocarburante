window.onload = function() {
            ...
            function gasolinerasStyle(feature) {
                return {
                    radius: 3,
                    fillColor: getColor(feature.properties.gasolina98),
                    color: "transparent",
                    weight: 1,
                    opacity: 1,
                    fillOpacity: 0.7
            ...
            $.getJSON(jsonURL, function(response) {
                ...
                document.getElementById('updated').innerHTML = "Gasolina 98, Precio actualizado el : "+ response.Fecha;
                ...
                // calculate breaks
                breaks = turf.jenks(geojsonData, 'gasolina98', 3);// Returns Array.<number> the break number for each class plus the minimum and maximum values
                ...
                */
                ...
                var gasolineras_fcLayer = L.geoJson(geojsonData, {
                    ...
                    onEachFeature: function(feature, layer) {
                        ...
                        "<br><b>Gasolina 98: </b>" + feature.properties.gasolina98 + ' €/l'+
                ...
                */
                ...
                legend.onAdd = function (map) {
                    ...
                    var div = L.DomUtil.create('div', 'info legend'),
                        labels = [];
                    div.innerHTML += '<p>Precio Gasolina 98 (€/l)</p>';
